...
router.post('/upload', auth, upload.single('file'), async (req, res) => {
    try {
        ...
        for (let row of jsonData) {
            ...
            const email = getField(row, ['email', 'Email', 'EMAIL', 'emailAddress', 'Email Address', 'email_address', 'Email_Address']);
            ...
            const category = getField(row, ['category', 'Category', 'CATEGORY']);
            const followersRange = getField(row, ['followersRange', 'Followers Range', 'followers range', 'Followers range', 'Followers Range', 'FOLLOWERS RANGE']);
